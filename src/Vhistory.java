...
public class Vhistory extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		response.setContentType("text/html");
		         ...
		         out.println("  <BODY>");
		         out.print(" <p> Visit History </p>");
		         for(HistoryObject o: SearchServer.visitHistory) {
		        	 	out.printf(" <p>%s<br/>"
		        	 			+ "Date: %s",o.getQuery(),o.getData());
		         }
		         out.print(" </p>");
		         out.println("<form method = \"post\" action = \"/visit history\">");
